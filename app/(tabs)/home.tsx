    ...
    <ScrollView>
      <View className="flex-1 bg-white mt-0">
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
          <View className="p-4">
            <Text className="text-2xl font-bold mb-4">Welcome, Bimal</Text>
            ...
            >
              <Text className="text-white font-bold">Community Board</Text>
            </TouchableOpacity>

            <Text className="text-xl font-bold mb-2">Interruption Alerts</Text>
            <View className="bg-white rounded-lg p-4 mb-4 shadow-md">
              <View className="flex-row border-b border-gray-200 pb-2 mb-2">
                <Text className="flex-1 text-gray-500 font-medium">
                  Interruption ID
                </Text>
                <Text className="flex-2 text-gray-500 font-medium">
                  Ater Description
                </Text>
                <Text className="flex-1 text-gray-500 font-medium text-right">
                  Sevierty
                </Text>
              </View>
              {[
                ...
                >
                  <Text className="flex-1 text-gray-700">{item.id}</Text>
                  <Text className="flex-2 text-gray-600">{item.desc}</Text>
                ...
                <View key={index} className="w-1/2 p-2">
                  <View className="bg-gray-100 p-4 rounded-lg">
                    <Ionicons
                      ...
                      color="black"
                    />
                    <Text className="font-bold mt-2">{facility.name}</Text>
